...
const result=readJavaScriptReconciliation({project:fs.realpathSync(values.get("--project")),projectPath:values.get("--project-path"),files:values.get("--files").split(","),moduleG1:fs.realpathSync(values.get("--module")),entryName:values.get("--entry"),nativeRunner:fs.realpathSync(values.get("--native-runner"))});
