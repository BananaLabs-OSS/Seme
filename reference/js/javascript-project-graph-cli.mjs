...
const graph=buildJavaScriptProjectGraph({files,snapshot:JSON.parse(fs.readFileSync(options.get("--snapshot"),"utf8")),canonicalG1:fs.readFileSync(options.get("--canonical-g1"),"utf8"),projectPath:options.get("--project"),rootModule:options.get("--root-module")});
