...
func v10Entities(b func(string) string) (string, string) {
	...
	return schema, field("e250", "durable_project_snapshot.resource_project_snapshot", "e024") + field("e251", "durable_project_snapshot.durable_state_plan", "8010") + field("e252", "durable_project_snapshot.content_revision", "")
}
...
func v10Exports() string {
	out := v9Exports()
	for _, x := range []string{"e025", "e250", "e251", "e252"} {
		out += fmt.Sprintf("rf 0000000000000000000000000000%s\n", x)
	}
	return out
}
