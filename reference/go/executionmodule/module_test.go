...
func TestVersion64PreservesVersion63Schema(t *testing.T) {
	previous, err := Declarations(63)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(64)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v64 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion65AddsTypedNativeSwitch(t *testing.T) {
	previous, err := Declarations(64)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(65)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion67AddsTypedNativeAddress(t *testing.T) {
	previous, err := Declarations(66)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(67)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion69PreservesVersion68Schema(t *testing.T) {
	previous, err := Declarations(68)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(69)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v69 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion70AddsNativeRange(t *testing.T) {
	previous, err := Declarations(69)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(70)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion72AddsTypedNativeDereference(t *testing.T) {
	previous, err := Declarations(71)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(72)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion74AddsTypedNativeIndexAssignment(t *testing.T) {
	previous, err := Declarations(73)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(74)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion76PreservesVersion75Schema(t *testing.T) {
	previous, err := Declarations(75)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(76)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v76 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion77PreservesVersion76Schema(t *testing.T) {
	previous, err := Declarations(76)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(77)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v77 unexpectedly changed canonical schema")
	}
}

func TestVersion78PreservesVersion77Schema(t *testing.T) {
	previous, err := Declarations(77)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(78)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v78 unexpectedly changed canonical schema")
	}
}

func TestVersion79PreservesVersion78Schema(t *testing.T) {
	previous, err := Declarations(78)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(79)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v79 unexpectedly changed canonical schema")
	}
}

func TestVersion80PreservesVersion79Schema(t *testing.T) {
	previous, err := Declarations(79)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(80)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v80 unexpectedly changed canonical schema")
	}
}

func TestVersion81AddsScopedTypeDeclaration(t *testing.T) {
	previous, err := Declarations(80)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(81)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous)+1 || current[len(previous)].Name != "ScopedTypeDeclaration" {
		t.Fatalf("v81 declarations = %#v", current[len(previous):])
	}
}

func TestVersion82PreservesVersion81Schema(t *testing.T) {
	previous, err := Declarations(81)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(82)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v82 unexpectedly changed canonical schema")
	}
}

func TestVersion83PreservesVersion82Schema(t *testing.T) {
	previous, err := Declarations(82)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(83)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v83 unexpectedly changed canonical schema")
	}
}

func TestVersion84PreservesVersion83Schema(t *testing.T) {
	previous, err := Declarations(83)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(84)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
...
func TestVersion86PreservesVersion85Schema(t *testing.T) {
	previous, err := Declarations(85)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(86)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v86 unexpectedly changed canonical schema")
	}
}

func TestVersion87PreservesVersion86Schema(t *testing.T) {
	previous, err := Declarations(86)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(87)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v87 unexpectedly changed canonical schema")
	}
}

func TestVersion88PreservesVersion87Schema(t *testing.T) {
	previous, err := Declarations(87)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(88)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v88 unexpectedly changed canonical schema")
	}
}

func TestVersion89PreservesVersion88Schema(t *testing.T) {
	previous, err := Declarations(88)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(89)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v89 unexpectedly changed canonical schema")
	}
}

func TestVersion90PreservesVersion89Schema(t *testing.T) {
	previous, err := Declarations(89)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(90)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v90 unexpectedly changed canonical schema")
	}
}

func TestVersion91PreservesVersion90Schema(t *testing.T) {
	previous, err := Declarations(90)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(91)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v91 unexpectedly changed canonical schema")
	}
}

func TestVersion92PreservesVersion91Schema(t *testing.T) {
	previous, err := Declarations(91)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(92)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v92 unexpectedly changed canonical schema")
	}
}

func TestVersion93PreservesVersion92Schema(t *testing.T) {
	previous, err := Declarations(92)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(93)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v93 unexpectedly changed canonical schema")
	}
}

func TestVersion94AddsNativeBindingAssignment(t *testing.T) {
	previous, err := Declarations(93)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(94)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion96PreservesVersion95Schema(t *testing.T) {
	previous, err := Declarations(95)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(96)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v96 unexpectedly changed canonical schema")
	}
}

func TestVersion97PreservesVersion96Schema(t *testing.T) {
	previous, err := Declarations(96)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(97)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
		t.Fatal("v97 unexpectedly changed canonical schema")
	}
}

func TestVersion98PreservesVersion97Schema(t *testing.T) {
	previous, err := Declarations(97)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(98)
	if err != nil {
		t.Fatal(err)
	}
	if !reflect.DeepEqual(current, previous) {
...
func TestVersion103AddsNativeChannelReceive(t *testing.T) {
	previous, err := Declarations(102)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(103)
	if err != nil {
		t.Fatal(err)
	}
...
func TestVersion105AddsNativeMethodValue(t *testing.T) {
	previous, err := Declarations(104)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(105)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous)+1 || current[len(previous)].ID != 0xa089 || current[len(previous)].Name != "NativeMethodValue" {
		t.Fatalf("v105 declarations = %#v", current[len(previous):])
	}
...
func TestVersion108KeepsSchemaStable(t *testing.T) {
	previous, err := Declarations(107)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(108)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v108 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion109KeepsSchemaStable(t *testing.T) {
	previous, err := Declarations(108)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(109)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v109 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion110KeepsSchemaStable(t *testing.T) {
	previous, err := Declarations(109)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(110)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v110 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion111KeepsSchemaStable(t *testing.T) {
	previous, err := Declarations(110)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(111)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v111 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion112KeepsSchemaStable(t *testing.T) {
	previous, err := Declarations(111)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(112)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
...
func TestVersion60PreservesVersion59Schema(t *testing.T) {
	previous, err := Declarations(59)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(60)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v60 declaration count = %d, want %d", len(current), len(previous))
	}
}

func TestVersion59PreservesVersion58Schema(t *testing.T) {
	previous, err := Declarations(58)
	if err != nil {
		t.Fatal(err)
	}
	current, err := Declarations(59)
	if err != nil {
		t.Fatal(err)
	}
	if len(current) != len(previous) {
		t.Fatalf("v59 declaration count = %d, want %d", len(current), len(previous))
	}
}
