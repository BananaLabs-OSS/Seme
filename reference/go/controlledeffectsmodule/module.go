...
func declarations() []schema {
	return []schema{
		...
		{0x13102, "ClockSample", []field{f(0x13220, "clock_sample.unix_milliseconds", 3, 0, 0), f(0x13221, "clock_sample.sequence", 3, 0, 0)}},
		{0x13103, "SeededRandomAuthority", []field{f(0x13230, "seeded_random_authority.identity", 4, 0, 0), f(0x13231, "seeded_random_authority.algorithm", 4, 0, 0), f(0x13232, "seeded_random_authority.overflow_policy", 4, 0, 0), f(0x13233, "seeded_random_authority.state_type", 5, 0x13104, 0)}},
		{0x13104, "SeededRandomState", []field{f(0x13240, "seeded_random_state.value", 3, 0, 0), f(0x13241, "seeded_random_state.draws", 3, 0, 0)}},
		...
		{0x13106, "ReplayStep", []field{f(0x13260, "replay_step.command_sequence", 3, 0, 0), f(0x13261, "replay_step.clock", 5, 0x13102, 0), f(0x13262, "replay_step.random_draw", 3, 0, 0), f(0x13263, "replay_step.effect_value", 1, 0, 0)}},
		{0x13107, "ControlledReplay", []field{f(0x13270, "controlled_replay.initial_seed", 3, 0, 0), f(0x13271, "controlled_replay.steps", 5, 0x13106, 2), f(0x13272, "controlled_replay.transcript_digest", 4, 0, 0), f(0x13273, "controlled_replay.duplicate_policy", 4, 0, 0), f(0x13274, "controlled_replay.rejection_policy", 4, 0, 0)}},
		{0x13108, "ControlledEffectsBounds", []field{f(0x13280, "controlled_effects_bounds.maximum_steps", 3, 0, 0), f(0x13281, "controlled_effects_bounds.first_clock_sequence", 3, 0, 0), f(0x13282, "controlled_effects_bounds.clock_terminal_sentinel", 3, 0, 0), f(0x13283, "controlled_effects_bounds.maximum_unix_milliseconds", 3, 0, 0), f(0x13284, "controlled_effects_bounds.minimum_seed", 3, 0, 0), f(0x13285, "controlled_effects_bounds.maximum_seed", 3, 0, 0), f(0x13286, "controlled_effects_bounds.maximum_draws", 3, 0, 0), f(0x13287, "controlled_effects_bounds.maximum_effects", 3, 0, 0)}},
	}
}
