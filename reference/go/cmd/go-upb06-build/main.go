// Command go-upb06-build is a bounded repository conformance adapter, not a
...
type options struct {
	...
	resourceManifest, resourceOwner, resourceV1, projectV9                                                string
...
func main() {
	if err := run(context.Background(), os.Args[1:], os.Stderr); err != nil {
		fmt.Fprintln(os.Stderr, "go-upb06-build:", err)
		os.Exit(1)
	}
}
func run(parent context.Context, args []string, stderr io.Writer) error {
	f := flag.NewFlagSet("go-upb06-build", flag.ContinueOnError)
	f.SetOutput(stderr)
	var o options
	flags := map[string]*string{"project": &o.project, "proxy": &o.proxy, "module": &o.module, "package": &o.pkg, "entry": &o.entry, "out": &o.out, "dependency": &o.dependency, "version": &o.version, "local-from": &o.localFrom, "local-to": &o.localTo, "selection": &o.manifest, "resources": &o.resourceManifest, "resource-owner": &o.resourceOwner, "execution-g1": &o.executionG1, "execution-contract": &o.execution, "foundation-contract": &o.foundation, "package-v4": &o.packageV4, "project-v8": &o.projectV8, "dependency-v1": &o.dependencyV1, "configuration-v3": &o.configurationV3, "resource-v1": &o.resourceV1, "project-v9": &o.projectV9, "k0": &o.k0, "g1-compiler": &o.compiler}
	for n, p := range flags {
	...
	defer cancel()
	v9, err := contractcatalog.ResolveProjectContractSetV9(read(o.foundation), read(o.execution), read(o.packageV4), read(o.dependencyV1), read(o.configurationV3), read(o.resourceV1), read(o.projectV9))
	if err != nil {
		return err
	}
	base := goupb05pipeline.V8Input{Documents: goprovider.DocumentSnapshot{Revision: o.revision, ModulePath: o.module, PackagePath: o.pkg, Entry: o.entry, Files: files}, Sources: sources, Contracts: v8, Dependency: goupb05pipeline.V8DependencyInput{ProjectRoot: root, ProxyRoot: o.proxy, Module: o.dependency, Version: o.version, LocalFrom: o.localFrom, LocalTo: o.localTo}, Selection: selection, ExecutionG1: read(o.executionG1), Compile: func(ctx context.Context, in []byte) ([]byte, error) { return compile(ctx, o, in) }}
	result, err := goupb06pipeline.Build(ctx, goupb06pipeline.Input{Base: base, Contracts: v9, Manifest: read(o.resourceManifest), OwnerPackage: o.resourceOwner})
	if err != nil {
		return err
	}
	return goupb06pipeline.Publish(o.out, result)
}
func (o options) validate() error {
	vals := []string{o.project, o.proxy, o.module, o.pkg, o.entry, o.out, o.dependency, o.version, o.localFrom, o.localTo, o.manifest, o.resourceManifest, o.resourceOwner, o.resourceV1, o.projectV9, o.executionG1, o.execution, o.foundation, o.packageV4, o.projectV8, o.dependencyV1, o.configurationV3, o.k0, o.compiler}
	for _, v := range vals {
		if v == "" {
...
func (o options) inputs() []string {
	return []string{o.manifest, o.resourceManifest, o.executionG1, o.execution, o.foundation, o.packageV4, o.projectV8, o.dependencyV1, o.configurationV3, o.resourceV1, o.projectV9, o.k0, o.compiler}
}
...
func compile(ctx context.Context, o options, in []byte) ([]byte, error) {
	d, e := os.MkdirTemp("", "seme-upb06-compile-")
	if e != nil {
		return nil, e
	}
