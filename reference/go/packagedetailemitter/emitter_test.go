...
func TestPackageDetailMetadataExtractsPrivatePublicAndAlias(t *testing.T) {
	...
	projected, err := goprojector.ProjectPackagesV2([]byte(fixtureG1()), artifact)
	if err != nil {
		t.Fatal(err)
	}
	rootSource := string(projected["example.test/tool/root"])
	if !strings.Contains(rootSource, "func helper(") || !strings.Contains(rootSource, "func Apply(") {
		t.Fatalf("private/public projection missing:\n%s", rootSource)
	}
	if strings.Contains(rootSource, "func Helper(") {
		t.Fatal("private helper was exported")
	}
	tampered := append(append([]byte(nil), artifact...), 'x')
	if got, e := goprojector.ProjectPackagesV2([]byte(fixtureG1()), tampered); e == nil || got != nil {
		t.Fatalf("strict projection accepted tamper: %#v %v", got, e)
	}
...
func fixtureG1() string {
	return `ve 1
mo 00000000000000000000000000009000
rv 00000000000000000000000000009023
pc 0
ec 17
en 00000000000000000000000000008001 00000000000000000000000000009010 1 0
en 00000000000000000000000000008002 00000000000000000000000000009012 1 3
fi 00000000000000000000000000009120 by 76616c7565
fi 00000000000000000000000000009121 rf 00000000000000000000000000008001
fi 00000000000000000000000000009122 uu 0
en 00000000000000000000000000008003 00000000000000000000000000009012 1 3
fi 00000000000000000000000000009120 by 76616c7565
fi 00000000000000000000000000009121 rf 00000000000000000000000000008001
fi 00000000000000000000000000009122 uu 0
en 00000000000000000000000000008004 00000000000000000000000000009012 1 3
fi 00000000000000000000000000009120 by 76616c7565
fi 00000000000000000000000000009121 rf 00000000000000000000000000008001
fi 00000000000000000000000000009122 uu 0
en 00000000000000000000000000008005 00000000000000000000000000009080 1 1
fi 00000000000000000000000000009800 li 1
rf 00000000000000000000000000008020
en 00000000000000000000000000008006 00000000000000000000000000009080 1 1
fi 00000000000000000000000000009800 li 1
rf 00000000000000000000000000008021
en 00000000000000000000000000008007 00000000000000000000000000009080 1 1
fi 00000000000000000000000000009800 li 1
rf 00000000000000000000000000008022
en 00000000000000000000000000008020 00000000000000000000000000009081 1 1
fi 00000000000000000000000000009810 li 1
rf 00000000000000000000000000008023
en 00000000000000000000000000008021 00000000000000000000000000009081 1 1
fi 00000000000000000000000000009810 li 1
rf 00000000000000000000000000008024
en 00000000000000000000000000008022 00000000000000000000000000009081 1 1
fi 00000000000000000000000000009810 li 1
rf 00000000000000000000000000008025
en 00000000000000000000000000008023 00000000000000000000000000009013 1 1
fi 00000000000000000000000000009130 rf 00000000000000000000000000008002
en 00000000000000000000000000008024 00000000000000000000000000009013 1 1
fi 00000000000000000000000000009130 rf 00000000000000000000000000008003
en 00000000000000000000000000008025 00000000000000000000000000009013 1 1
fi 00000000000000000000000000009130 rf 00000000000000000000000000008004
en 00000000000000000000000000008010 00000000000000000000000000009011 1 4
fi 00000000000000000000000000009110 by 4e6f726d616c697a65
fi 00000000000000000000000000009111 li 1
rf 00000000000000000000000000008002
fi 00000000000000000000000000009112 rf 00000000000000000000000000008001
fi 00000000000000000000000000009113 rf 00000000000000000000000000008005
en 00000000000000000000000000008011 00000000000000000000000000009011 1 4
fi 00000000000000000000000000009110 by 4170706c79
fi 00000000000000000000000000009111 li 1
rf 00000000000000000000000000008003
fi 00000000000000000000000000009112 rf 00000000000000000000000000008001
fi 00000000000000000000000000009113 rf 00000000000000000000000000008006
en 00000000000000000000000000008012 00000000000000000000000000009011 1 4
fi 00000000000000000000000000009110 by 68656c706572
fi 00000000000000000000000000009111 li 1
rf 00000000000000000000000000008004
fi 00000000000000000000000000009112 rf 00000000000000000000000000008001
fi 00000000000000000000000000009113 rf 00000000000000000000000000008007
en 00000000000000000000000000008013 00000000000000000000000000009015 1 2
fi 00000000000000000000000000009150 li 3
rf 00000000000000000000000000008010
rf 00000000000000000000000000008011
rf 00000000000000000000000000008012
fi 00000000000000000000000000009151 rf 00000000000000000000000000008011
`
}
