...
work=$(mktemp -d "${TMPDIR:-/tmp}/seme-execution-v10.XXXXXX")
...
cp -R "$repo/fixtures/go-execution-v10" "$work/project"
...
"$work/go-lift" \
    ...
    --module "$execution/module.g1" --function SubtractNested \
...
echo "Core Execution v10: ordered compositional integer subtraction passed"
