...
`ReconciledProjectRevision` (`e036`). It binds SHA-256 digests of exact prior
and resulting Project-v13 snapshots, one Patch-v1 transaction, a monotonic client revision,
