...
v1 declaration set. It contains 16 schemas, their field declarations, recursive
ValueShape, PathSegment, and ValidationResult records, and the distinct
Foundation module identity above frozen Kernel v1.
