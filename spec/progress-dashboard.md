...
Snapshot: 2026-09-08 after Core v26.

Percentages answer different questions and must not be conflated:

| Goal | Progress | Basis |
|---|---:|---|
| Defined Core restoration checkpoints | 86% | 25 of the 29 additive checkpoints from v2 through v30 have been reached; many remain intentionally marked in progress until broader composition evidence exists. |
...
| Bounded Go/JavaScript semantic bridge | about 58% | Estimate for the deliberately supported, tested language subset—not either complete language. |
| Useful small-application subset | about 48% | Estimate against the semantics needed for modest deterministic applications. |
