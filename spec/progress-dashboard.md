...
Snapshot: 2026-09-08 after Core v29.

Percentages answer different questions and must not be conflated:

| Goal | Progress | Basis |
|---|---:|---|
| Defined Core restoration checkpoints | 97% | 28 of the 29 additive checkpoints from v2 through v30 have been reached; many remain intentionally marked in progress until broader composition evidence exists. |
...
| Bounded Go/JavaScript semantic bridge | about 76% | Estimate for the deliberately supported, tested language subset—not either complete language. |
| Useful small-application subset | about 68% | Estimate against the semantics needed for modest deterministic applications. |
