...
| Useful Project Bridge Profile v1 | 0/36 cells (0%) | The denominator is 12 capabilities × 3 languages with seven evidence classes per cell. Project Contract v2, canonical source inventories, hardened five-class Go discovery, detached digest bundles, and the three-package Go source-to-Seme/target foundation are complete; true semantic project projection, fidelity evidence, and full atomic rejection still block Go UPB-01. |
