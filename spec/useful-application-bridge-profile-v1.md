...
The repository currently justifies 17/36 UAB-v1 cells: UAB-01 through UAB-04
pass all five evidence classes independently for Go, JavaScript, and Lua;
UAB-05 passes for all three languages; and Go and JavaScript UAB-06 pass. It does
not yet justify any other cell because:
