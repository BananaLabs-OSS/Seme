...
The repository currently justifies 27/36 UAB-v1 cells: UAB-01 through UAB-09
pass all five evidence classes independently for Go, JavaScript, and Lua. It
does not yet justify any other cell because:
