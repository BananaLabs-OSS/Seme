...
The repository currently justifies 11/36 UAB-v1 cells: UAB-01 through UAB-03
pass all five evidence classes independently for Go, JavaScript, and Lua, and
JavaScript and Lua UAB-04 pass all five. It does not yet justify any other cell because:
