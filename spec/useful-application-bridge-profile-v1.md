...
The repository currently justifies 10/36 UAB-v1 cells: UAB-01 through UAB-03
pass all five evidence classes independently for Go, JavaScript, and Lua, and
JavaScript UAB-04 passes all five. It does not yet justify any other cell because:
