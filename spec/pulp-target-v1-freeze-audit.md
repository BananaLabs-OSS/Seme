...
| Request/response | pass | One cell instance processes four Application Wire v2 records, returning three ResultOk values and one source-derived ResultError. |
...
Pulp runtime evidence is pinned at commit `c303c74`; the conformance gate
...
schema-derived versioned request record. General branching, recursive values,
