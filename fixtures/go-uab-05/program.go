...
func (adjuster OffsetAdjuster) Adjust(value int64) int64 { return value + adjuster.Offset }

type ScaleAdjuster struct{ Factor int64 }

func (adjuster ScaleAdjuster) Adjust(value int64) int64 { return value * adjuster.Factor }
